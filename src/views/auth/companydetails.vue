    ...
    <form @submit.prevent="submit">
      <div class="pb-10">
        <div class="d-flex align-center">
          ...
          <div class="font__sm">Company Registration Document</div>
        </div>
      ...
      <div>
        <div class="d-flex align-center">
          <div class="green__bullet mr-4"></div>
          <div class="font__sm">Office Address</div>
        </div>
        <div>
          <v-row>
            ...
            <v-col md="4" sm="6" xs="12">
              <div class="font__x__sm pt-4 pb-4">Street</div>
...
export default {
  ...
  methods: {
    ...
    next() {
      ...
      EventBus.$emit("change", ["location", 3, this.body, "compdetails"]);
    },
    prev() {
      EventBus.$emit("change", ["iddetails", 1]);
    },
    async retValue() {
      axios({
        method: "GET",
